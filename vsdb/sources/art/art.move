...
module suiDouBashi_vsdb::art{
    ...
    fun init(otw: ART, ctx:&mut TxContext){
        ...
        let display = display::new_with_fields<Chicken>(&publisher, keys, values, ctx);
    ...
    public entry fun mint(dna: u128, ctx: &mut TxContext){
