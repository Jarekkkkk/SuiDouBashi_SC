...
module suiDouBashi::abc {
    use suiDouBashi::r_coin::{Self as rcoin, RegulatedCoin as RCoin};
...
/// ```
module suiDouBashi::tests {
    use suiDouBashi::abc::{Self, Abc, AbcTreasuryCap, Registry};
    use suiDouBashi::r_coin::{Self as rcoin, RegulatedCoin as RCoin};
    ...
    #[test]
    #[expected_failure(abort_code = suiDouBashi::abc::EAddressBanned)]
    ...
    #[test]
    #[expected_failure(abort_code = suiDouBashi::abc::ENotOwner)]
